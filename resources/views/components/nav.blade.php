            ...
            <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                <li class="mr-6 my-2 md:my-0">
                    <a href="/"
                        ...
                        <i class="fas fa-tasks fa-fw mr-3"></i><span
                            class="pb-1 md:pb-0 text-sm">Today's Activities</span>
                    </a>
                </li>
                <li class="mr-6 my-2 md:my-0">
                    <a href="/edit-tags"
                        ...
                        <i class="fas fa-tasks fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Edit Tags</span>
                    </a>
                </li>
                <li class="mr-6 my-2 md:my-0">
                    <a href="/analytics"
                ...
                <li class="mr-6 my-2 md:my-0">
                    <a href="/export"
                        ...
                        <i class="fa fa-envelope fa-fw mr-3"></i><span class="pb-1 md:pb-0 text-sm">Export</span>
                    </a>
                </li>
            </ul>
