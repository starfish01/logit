        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden lg:block mt-2 lg:mt-0 bg-gray-900 z-20"
            ...
            <ul class="list-reset lg:flex flex-1 items-center px-4 md:px-0">
                <li class="mr-6 my-2 md:my-0">
                    <x-buttons href="/" name="nav-main" icon="fa-tasks" :active="'activities'">Today's Activities</x-buttons>
                </li>
                <li class="mr-6 my-2 md:my-0">
                    <x-buttons href="/edit-tags" name="nav-main" icon="fa-tasks" :active="'tags'">Edit Tags</x-buttons>
                </li>
                <li class="mr-6 my-2 md:my-0">
                    <x-buttons href="/analytics" name="nav-main" icon="fa-chart-area" :active="'analytics'">Analytics</x-buttons>
                </li>
                <li class="mr-6 my-2 md:my-0">
                    <x-buttons href="/export" name="nav-main" icon="fa-envelope" :active="'export'">Export</x-buttons>
                </li>
            </ul>
