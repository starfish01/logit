<div class="w-full md:w-1/2 p-3" x-data="{ show: false }">
    ...
    <div x-show="show" class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
        aria-modal="true">
        <div class="flex items-center justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div @click.away="show = false"
                ...
                <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                    ...
                    <button @click="show = false" type="button" class="mb-3 px-4 py-2 font-semibold ">
                        Cancel
                    </button>
                </div>
            </div>
